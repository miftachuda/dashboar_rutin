...
import { useLiveTanks, predefinedTankList, getTargetEta, normalizeTankKey, TankRow, TankRecord, TankHistoryPoint, ConnectionStatus, SortKey, SortDirection, RateUnit } from "@/hooks/useLiveTanks";
...
const LiveTankLevel: React.FC = () => {
  ...
  const { status, errorMessage, rowsByTank, tankHistoryByKey, now, tankDataByKey, tankData, setTankData } = useLiveTanks();
